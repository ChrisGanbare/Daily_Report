...
from src.utils.ui_utils import FileDialogUtil, choose_file, choose_directory
...
class TestUtilsUi_utils(BaseTestCase):
    ...
    def test_filedialogutil_choose_file(self, mock_askopenfilename, mock_tk):
        ...
        # 调用方法
        result = self.dialog_util.choose_file("选择文件", [("Text files", "*.txt")], "/initial/dir")
    ...
    @patch('src.utils.ui_utils.tk.Tk')
    @patch('src.utils.ui_utils.filedialog.askopenfilename')
    def test_filedialogutil_choose_file_user_cancel(self, mock_askopenfilename, mock_tk):
        """
    ...
    @patch('src.utils.ui_utils.tk.Tk')
    @patch('src.utils.ui_utils.filedialog.askopenfilename')
    def test_filedialogutil_choose_file_without_optional_params(self, mock_askopenfilename, mock_tk):
        """
    ...
    @patch('src.utils.ui_utils.tk.Tk')
    @patch('src.utils.ui_utils.filedialog.askdirectory')
    def test_filedialogutil_choose_directory_user_cancel(self, mock_askdirectory, mock_tk):
        """
    ...
    @patch('src.utils.ui_utils.tk.Tk')
    @patch('src.utils.ui_utils.filedialog.askdirectory')
    def test_filedialogutil_choose_directory_without_optional_params(self, mock_askdirectory, mock_tk):
        """
    ...
    def test_choose_file(self, mock_util):
        ...
        # 验证结果
        self.assertEqual(result, "/path/to/file.txt")
        mock_util.choose_file.assert_called_once_with("选择文件", [("Text files", "*.txt")], "/initial/dir")
